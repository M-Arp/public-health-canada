...
We have recoded variables X, Y and Z into variables `know1`, `know2` and `know3` such that respondents were coded 1 if they were correct and 0 if they were incorrect. 
...
We have recoded variables X, Y and Z into variables `crt1`, `crt2` etc.such that respondents were coded 1 if they got the correct response and 0 if they were incorrect. 
